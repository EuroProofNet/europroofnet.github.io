...
###### Francesco Gavazzo: A Mathematical Theory of Term Relations [[Slides](./talks/gavazzo.pdf)] {#fgavazzo}
...
###### András Kovács: A generalized logical framework [[Slides](./talks/kovacs.pdf)] {#akovacs}
...
###### Thomas Lamiaux: A unified Framework for Initial Semantics, and it is 2 functorial [[Slides](./talks/lamiaux.pdf)] {#tlamiaux}
...
###### Paige Randall North: Comparing semantic frameworks for dependently-sorted algebraic theories [[Slides](./talks/north.pdf)] {#prnorth}
...
###### Thorsten Altenkirch: Containers in Higher Kinds [[Slides](./talks/altenkirch.pdf)] {#taltenkirch}
...
###### Mathis Bouverot-Dupuis: Code Generation via Meta-programming in Dependently Typed Proof Assistants [[Slides](./talks/bouverot-dupuis.pdf)] {#mbouverot}
...
###### Stefania Damato: Distributive Laws for Monadic Containers [[Slides](./talks/damato.pdf)] {#sdamato}
...
###### Michele De Pascalis: Monoid Structures on Indexed Containers [[Slides](./talks/de-pascalis.pdf)] {#mdepascalis}
...
###### Maximilian Doré: Linear Types with Dynamic Multiplicities in Dependent Type Theory [[Slides](./talks/dore.pdf)] {#mdore}
...
###### Andrea Giusto: Fibrations with comprehension and their completion [[Slides](./talks/giusto.pdf)] {#agiusto}
...
###### Andrea Laretto: Directed First-Order Logic [[Slides](./talks/laretto.pdf)] {#alaretto}
...
###### Niyousha Najmaei: Syntax for non-full comprehension categories [[Slides](./talks/najmaei.pdf)] {#nnajmaei}
...
###### Jacob Neumann: GATs, Cats, and CwFs: A Celestial Dance [[Slides](./talks/neumann.pdf)] {#jneumann}
...
###### Samuel Novotný: Towards Resolving Type Inconsistencies in Transparent Intensional Logic [[Slides](./talks/novotny.pdf)] {#snovotny}
...
###### Lorenzo Perticone: Parametric Distributive Laws: uniform monad composition [[Slides](./talks/perticone.pdf)] {#lperticone}
...
###### Iosif Petrakis: Categories with dependent and codependent arrows [[Slides](./talks/petrakis.pdf)] {#ipetrakis}
...
###### Daniel Ranalter: Erasure-Respecting Semantics for DHOL [[Slides](./talks/ranalter.pdf)] {#dranalter}
...
###### Pietro Sabelli: On the conservativity of type theories with classical logic over arithmetic [[Slides](./talks/sabelli.pdf)] {#psabelli}
...
###### Matteo Spadetto: A 2-categorical approach to the sematics of axiomatic dependent type theory [[Slides](./talks/spadetto.pdf)] {#mspadetto}
...
###### Théo Winterhalter: Local abstraction over computation in type theory [[Slides](./talks/winterhalter.pdf)] {#twinterhalter}
