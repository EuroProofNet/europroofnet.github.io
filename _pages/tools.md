...
- [SMTCoq](https://smtcoq.github.io/): tool to use and checkof proofs from SMT solver in Coq
- [Isabelle/HOL](https://isabelle.in.tum.de/) can reconstruct proofs generated by veriT and Z3
